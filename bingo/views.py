...
# ==========================================
# Esta es la ruta maestra que carga tu archivo dashboard_admin.html (SPA)
@login_required
def dashboard(request):
    ...
    return render(request, 'administrador/dashboard_admin.html', contexto)
...
def venta_cartones(request):
    ...
    return render(request, 'negocios/venta_cartones.html', contexto)
